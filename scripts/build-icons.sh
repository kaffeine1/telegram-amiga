...
# fallback for 3.1. The program icon comes from the 64 pixel AmigaOS 4
# artwork, not from the 46 pixel OS3 file: on a real 3.x box the small one
# looked coarse next to the 64 pixel icon it replaced. The
